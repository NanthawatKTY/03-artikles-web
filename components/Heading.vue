    ...
    <div class="container">
      <div class="content-container">
        <div class="text-container">
          ...
          <h2 :class="isDarkMode ? 'text-darkMode' : null">Designing search for mobile apps</h2>
          <p :class="isDarkMode ? 'text-darkMode' : null" class="date">Aug 26th, 2021, 4pm</p>
          <p :class="isDarkMode ? 'text-darkMode' : null" class="snippet">
